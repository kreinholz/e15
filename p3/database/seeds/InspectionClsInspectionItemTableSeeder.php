...
class InspectionClsInspectionItemTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $inspection_items_1 = InspectionItem::whereBetween('id', [1, 11])->get();
        $inspection_items_2 = InspectionItem::whereBetween('id', [12, 14])->get();
        $inspection_items_3 = InspectionItem::where('id', '>', '14')->get();
